...
function openFullscreen() {
    console.log("inside open full screen");
    if (elem.requestFullscreen) {
        console.debug("Called open Full Screen regular");
        elem.requestFullscreen().catch( function(err) {
            console.error("Got error in opening full-screen");
        });
        console.debug("Called open Full Screen adding the text etc.");
        var text2 = `
   ...
   <button>
     ...
     `;
        ...
        console.error("No fullscreen option here");
    }
}
