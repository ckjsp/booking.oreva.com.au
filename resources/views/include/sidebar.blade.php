...
<hr class="text-secondary my-0"/>
  <ul class="menu-inner align-items-center ">
      <!-- Dashboards -->
      <li class="nav-item">
          <a href="{{ route('home') }}"  class="customnav-link">
      ...
      <!-- Users List -->
      <li class="nav-item ">
          <a href="{{ route('customers.index') }}" class="customnav-link">
...
<li class="nav-item">
  <a href="{{ route('settings.index') }}" class="customnav-link">
...
<li class="nav-item">
      <a href="{{ route('logout') }}" class="customnav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
  ...
  <path d="M15 12H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h11" />
  </svg>
      </a>
