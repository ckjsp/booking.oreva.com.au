...
<head>
    ...
    <title>Invoice</title>
    <style>
        /* This can be used for local testing, but inline styles are preferred in the email body */
        body {
...
<body>
    <div class="invoice-box" style="width: 90%; max-width: 800px; margin: auto; padding: 20px; border: 1px solid #eee; background-color: #fff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.15); border-radius: 6px;">
