    ...
    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
      <div class="card-header flex-column flex-md-row">
        <div class="head-label text-center">
          <h2 class="card-title mb-0">All Builders</h2>
        </div>
        <div class="dt-action-buttons text-end pt-6 pt-md-0">
          <div class="dt-buttons flex-wrap">
          <a href="{{ route('user_builders.create') }}" class="btn btn-primary create-new waves-effect waves-light btn-dark rounded" 
                ...
                <td class="d-flex justify-content-center align-items-center">
                  <div class="d-inline-block">
                    ...
                    <a href="{{ route('user_builders.edit', $builder->id) }}" class="btn p-0 edit-btn dropdown-item">
                      ...
                      @csrf
                      @method('DELETE')
                      <button type="button" class="btn p-0 delete-btn text-danger dropdown-item" data-customer-id="{{ $builder->id }}" data-bs-toggle="modal" data-bs-target="#deleteModal">
