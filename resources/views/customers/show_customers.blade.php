                        ...
                        <td class="p-2" style="border: 1px solid #DDDDDD !important;">
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="button" class="btn p-2 view-btn text-dark btn-outline-light show-customer-btn"
                                    onclick="window.location.href='{{ route('lists.addcartproduct', ['list' => $list->id, 'customer' => $list->customer_id]) }}'">
                                    <i class="ti ti-plus me-sm-1 border border-dark rounded-circle mx-1 me-2 text-dark"></i>
                                </button>
                            </div>
                        </td>
                    </tr>
...
<script>
    ...
    $(document).ready(function() {
        $('#customerListsTable').DataTable({
            "order": [[0, 'desc']] // Adjust based on the column you want to sort by
        });
    });
</script>
